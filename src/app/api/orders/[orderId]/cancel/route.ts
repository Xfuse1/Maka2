...
export async function POST(
  ...
  try {
    ...
    console.log("[CANCEL API] Starting cancel for order:", orderId)
    ...
    console.log("[CANCEL API] Order fetch result:", order)
    if (orderError) {
    ...
    console.log("[CANCEL API] Current Status:", order.status)
    ...
    if (orderItems && orderItems.length > 0) {
      console.log("[CANCEL API] Restoring stock for items:", orderItems.length)
    ...
    console.log("[CANCEL API] Update success. Data:", updatedData)
