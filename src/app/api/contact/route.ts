...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log('[Contact API] supabase url present:', !!supabaseUrl, 'service key present:', !!supabaseServiceKey)
    ...
    console.log('[Contact API] insert result raw:', JSON.stringify(insertResult))
